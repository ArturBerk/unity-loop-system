...
namespace Abg
{
    ...
    {
        public static readonly ILoopSystem Initialization = new LoopSystem<Initialization>();
        public static readonly ILoopSystem EarlyUpdate = new LoopSystem<EarlyUpdate>();
